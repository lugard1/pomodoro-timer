...
## Learning Objectives
- Understand how to replicate a cool Pomodoro Timer application which can be used for setting time reminders for good time kepping at work or study it supports excellent user experience, and has beautiful user interface.

## Description of the Project
For the first milestone in the process of creating Pomorodo Timer application, you will:
